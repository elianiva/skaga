  ...
  return (
    <Layout title="Struktur Organisasi">
      <div className="max-w-5xl m-auto pt-24">
        ...
        <div className="grid grid-cols-12 grid-flow-col-dense open-sans text-blue-900 text-lg leading-relaxed mb-8">
          <div className="col-span-5">
            <div className="mb-8">
              ...
              <div className="grid grid-cols-8">
                ...
                <p className="col-start-3 col-end-8">Rahmah Hidana, M.Si.</p>
                <p className="col-start-3 col-end-8">Syahroni, S.Pd. </p>
              </div>
            </div>
            <div className="mb-8">
              <h1 className="text-xl font-bold">Pengurus</h1>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Ketua LSP:</p>
                <p className="col-start-4 col-end-8">Kristin Asri, S.Pd.</p>
              </div>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Sekretaris :</p>
                <p className="col-start-4 col-end-8">Dyah Wijayanti, S.Pd.</p>
              </div>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Ketua Komite Skema :</p>
                <p className="col-start-4 col-end-8">Sutejo, S.Pd.</p>
              </div>
            </div>
            <div className="mb-8">
              <h1 className="text-xl font-bold">Ketua Bidang</h1>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Manajemen Mutu :</p>
                <p className="col-start-4 col-end-8">Siti Armini, S.Pd.</p>
              </div>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Keuangan :</p>
                <p className="col-start-4 col-end-8">
                  Novaning Prahasti, S.Pd.
                </p>
              </div>
              <div className="grid grid-cols-8">
                <p className="col-span-3">Teknis Sertifikasi</p>
                <p className="col-start-4 col-end-8">Tintin Ratnawati, S.Pd.</p>
                <p className="col-start-4 col-end-8">Sri Wahyuni, S.Pd.</p>
              </div>
            </div>
          </div>
